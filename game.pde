class Game
{
    ...
    private CloudManager cloud_manager;
    private PVector camera_position;
    private float bedrock_level;
    private float scroll_speed;
    private boolean running = true;
    
    Game(InputManager input_manager, SoundManager sound_manager, float bedrock_level, float scroll_speed)
    {
        ...
        this.cloud_manager = new CloudManager(4, this.texture_manager);
